...
var Result = function Result(props) {
  var _props$content = props.content,
      extrovert = _props$content.extrovert,
      introvert = _props$content.introvert,
      intuition = _props$content.intuition,
      sensing = _props$content.sensing,
      thinking = _props$content.thinking,
      feeling = _props$content.feeling,
      judging = _props$content.judging,
      prospecting = _props$content.prospecting;

  var result = '';
  if (extrovert > introvert) result += 'E';else result += 'I';
  if (sensing > intuition) result += 'S';else result += 'N';
  if (feeling > thinking) result += 'F';else result += 'T';
  if (judging > prospecting) result += 'J';else result += 'P';
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_reactRouterDom.Route, { path: '/personality_types', component: _components.Main }),
            _react2.default.createElement(_reactRouterDom.Route, { path: '/results', component: _Result2.default })
          )
        )
      );
    }
...
exports.default = shuffledQuestions;
...
var Count = function Count(props) {
  return _react2.default.createElement(
    'p',
    { className: 'counter' },
    'Question ' + (props.count + 1) + ' of ' + props.total
  );
};
...
var Header = function Header() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement('div', { id: 'line-break' })
  );
};
...
var _Question = __webpack_require__(46);
...
var _questions = __webpack_require__(42);
...
var Main = function (_Component) {
  ...
  _createClass(Main, [{
    ...
    value: function componentWillMount() {
      this.setState({
        question: _questions2.default[this.state.counter]
      });
    }
  }, {
    key: 'handleClick',
    ...
    key: 'handleNextClick',
    value: function handleNextClick(evt) {
      evt.preventDefault();
      var newAnswersCount = Object.assign({}, this.state.answersCount);
    ...
    value: function showNextQuestion() {
      var counter = this.state.counter + 1;
      if (counter < _questions2.default.length) {
        this.setState({
          counter: counter,
          question: _questions2.default[counter],
          answer: 0
        });
      } else {
        this.setState({
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        finished ? _react2.default.createElement(_Result2.default, { content: answersCount }) : _react2.default.createElement(_Question2.default, {
...
function Question(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'div',
      { className: 'wrapper' },
      _react2.default.createElement(_Count2.default, { count: props.count, total: props.total }),
      _react2.default.createElement(
        'div',
        { className: 'question' },
        props.content
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'answer-label', id: 'disagree' },
            'Disagree'
          )
        ),
        _react2.default.createElement(
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_history_createBrowserHistory__ = __webpack_require__(31);
